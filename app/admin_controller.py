...
def dashboard():
  ...
  active_user = us.get_user(user_id=active_user_tuple[0])
  events_amount = active_user_tuple[1]
  popular_squawk = ss.get_squawk(squawk_id=popular_squawk_tuple[0])
  replies_amount = popular_squawk_tuple[1]
